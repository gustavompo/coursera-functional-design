...
$c_Lcalculator_Calculator$.prototype.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D = (function(expr, evaluated, references) {
  _internalEval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a = x3.a$2;
      var b = x3.b$2;
      var evaluated$1 = evaluated;
      var v1 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(a, evaluated$1), $as_sci_Set(evaluated$1.$$plus__O__sc_Set(a)), references);
      var v2 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(b, evaluated$1), $as_sci_Set(evaluated$1.$$plus__O__sc_Set(b)), references);
      return (v1 + v2)
    } else if ($is_Lcalculator_Minus(x1)) {
      var x4 = $as_Lcalculator_Minus(x1);
      var a$2 = x4.a$2;
      var b$2 = x4.b$2;
      var evaluated$1$1 = evaluated;
      var v1$1 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(a$2, evaluated$1$1), $as_sci_Set(evaluated$1$1.$$plus__O__sc_Set(a$2)), references);
      var v2$1 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(b$2, evaluated$1$1), $as_sci_Set(evaluated$1$1.$$plus__O__sc_Set(b$2)), references);
      return (v1$1 - v2$1)
    } else if ($is_Lcalculator_Times(x1)) {
      var x5 = $as_Lcalculator_Times(x1);
      var a$3 = x5.a$2;
      var b$3 = x5.b$2;
      var evaluated$1$2 = evaluated;
      var v1$2 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(a$3, evaluated$1$2), $as_sci_Set(evaluated$1$2.$$plus__O__sc_Set(a$3)), references);
      var v2$2 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(b$3, evaluated$1$2), $as_sci_Set(evaluated$1$2.$$plus__O__sc_Set(b$3)), references);
      return (v1$2 * v2$2)
    } else if ($is_Lcalculator_Divide(x1)) {
      var x6 = $as_Lcalculator_Divide(x1);
      var a$4 = x6.a$2;
      var b$4 = x6.b$2;
      var evaluated$1$3 = evaluated;
      var v1$3 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(a$4, evaluated$1$3), $as_sci_Set(evaluated$1$3.$$plus__O__sc_Set(a$4)), references);
      var v2$3 = this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(b$4, evaluated$1$3), $as_sci_Set(evaluated$1$3.$$plus__O__sc_Set(b$4)), references);
      return (v1$3 / v2$3)
    } else if ($is_Lcalculator_Ref(x1)) {
      var x7 = $as_Lcalculator_Ref(x1);
      var nm = x7.name$2;
      var res = this.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr(this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(nm, references), evaluated);
      var temp$evaluated = $as_sci_Set(evaluated.$$plus__O__sc_Set(res));
      expr = res;
      evaluated = temp$evaluated;
...
$c_Lcalculator_Calculator$.prototype.handleCyclic$1__p1__Lcalculator_Expr__sci_Set__Lcalculator_Expr = (function(ex, evaluated$1) {
  return (evaluated$1.contains__O__Z(ex) ? new $c_Lcalculator_Literal().init___D((NaN)) : ex)
});
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var jsx$2 = $as_sc_TraversableLike($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(namedExpressions, f, bf));
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_T2(x$1$2);
    if ((x$1 !== null)) {
      var a = $as_T2(x$1.$$und2$f);
      return a
    } else {
  ...
  return $as_sci_Map(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$2)))
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.internalEval$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(expr, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      var deltaVal = $uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2).apply__O());
      var bVal = (-$uD(b$2.apply__O()));
      var aVal = $uD(a$2.apply__O());
      var r1 = ((bVal + $uD($g["Math"]["sqrt"](deltaVal))) / (2 * aVal));
      var r2 = ((bVal - $uD($g["Math"]["sqrt"](deltaVal))) / (2 * aVal));
      var array = [r1, r2];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(kv) {
  var jsx$1 = kv.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, kv$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(kv$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, kv));
  var a = new $c_T2().init___O__O(jsx$1, new $c_Lcalculator_Signal().init___F0(expr));
  return new $c_T2().init___O__O(kv, a)
});
